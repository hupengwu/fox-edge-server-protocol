...
//        JDefaultTemplate template = TemplateFactory.getTemplate("fox-edge-server-device-protocol-mitsubishi-plc-fx").getTemplate(templateName, tableName, JDefaultTemplate.class);
