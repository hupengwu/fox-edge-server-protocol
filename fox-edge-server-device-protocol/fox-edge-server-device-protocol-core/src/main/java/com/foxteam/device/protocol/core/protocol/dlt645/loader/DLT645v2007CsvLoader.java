package com.foxteam.device.protocol.core.protocol.dlt645.loader;
...
import com.foxteam.device.protocol.core.protocol.dlt645.entity.DLT645DataFormatEntity;
...
public class DLT645v2007CsvLoader {
    ...
    public List<DLT645DataEntity> loadCsvFile(String table) {
        ...
        File file = new File(dir.getAbsolutePath() + "/template/dlt645/template/" + table);
