...
import com.foxteam.device.protocol.core.constants.FoxEdgeConstant;
import com.foxteam.device.protocol.core.exception.ProtocolException;
import com.foxteam.device.protocol.core.method.FoxEdgeReportMethod;
...
public class FoxEdgeReportWorker {
    ...
    public static Map<String, Object> decode(String deviceType, Object recv, Map<String, Object> params) throws ProtocolException {
        ...
        // 根据设备类型查找解码器集合
        Map<String, FoxEdgeReportMethod> methodPairs = FoxEdgeMethodTemplate.inst().getReportMethod().get(deviceType);
        if (methodPairs == null) {
