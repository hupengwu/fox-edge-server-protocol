# fox-edge-server-device-protocol-mitsubishi-plc-fx
...
``` 
发→◇02 30 30 30 41 30 30 31 03 36 35 □从Y0开始读取1个BYTE Y7-Y0

收←◆02 33 46 03 37 43 此时读取的数据为3F

[17:18:38.339]发→◇02 31 31 30 46 36 30 34 33 34 31 32 43 44 41 42 03 34 39 □

[17:18:38.370]收←◆06

[17:19:32.687]发→◇02 30 31 30 46 36 30 34 33 34 03 37 34 □读取10f6(D123)的0434位数据

[17:19:32.725]收←◆02 33 34 31 32 43 44 41 42 03 44 37 此时读取的数据即写入的数据1234ABCD
``` 
