...
public class TriggerConfigVOFieldConstant extends BaseVOFieldConstant {
    /**
     * 字段名称
     */
    ...
    public static final String field_queue_deep = "queueDeep";
    public static final String field_trigger_param = "params";
}
