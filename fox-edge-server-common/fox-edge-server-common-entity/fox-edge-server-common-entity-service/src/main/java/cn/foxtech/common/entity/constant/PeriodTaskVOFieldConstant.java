...
public class PeriodTaskVOFieldConstant  extends BaseVOFieldConstant {
    /**
     * 字段名称
     */
    ...
    public static final String field_select_device = "selectDevice";
    ...
    public static final String field_count_object_bind = "countObjectBind";
